let test = ["m", "dm", "cm", "mm"];
let weight = ["kg","g"];
if (process.argv.length != 6 || process.argv[4] != "to" || (test.indexOf(process.argv[5]) == -1 && weight.indexOf(process.argv[5]) == -1) || (test.indexOf(process.argv[3]) == -1 && weight.indexOf(process.argv[3]) == -1) || isNaN(process.argv[2]) || (test.indexOf(process.argv[3]) != -1 && weight.indexOf(process.argv[5]) != -1) || (test.indexOf(process.argv[5]) != -1 && weight.indexOf(process.argv[3]) != -1 )) {
